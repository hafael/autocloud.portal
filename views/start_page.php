  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="#"><?=$this->home->company_name?></a>
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <?php 
                ...
                if($this->pages->home) echo '<li class="active"><a href="#">Home</a></li>';
                if($this->pages->about) echo '<li><a href="#about">About</a></li>';
                if($this->pages->contact) echo '<li><a href="#contact">Contact</a></li>';
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            <h1><?=$this->home->company_name?></h1>
            <h2><?=$this->input->server('HTTP_HOST')?></h2>
      ...
      <footer>
        <p><?=$this->home->company_name?> &copy; 2013</p>
      </footer>
